...
namespace LiteGraphFrame
{
    class FieldPortData : PortDataBase
    {
        ...
        public string FieldValue { get { return m_FieldValue; } set { m_FieldValue = value; } }
        ...
        public void InitFieldIfno(FieldInfo fieldInfo, string fieldDescription)
        {
            ...
            m_FieldValue = fieldInfo.GetValue(NodeData) == null ? "" : fieldInfo.GetValue(NodeData).ToString();
        ...
        public override JsonData Encoder()
        {
            ...
            jsonData["FieldValue"] = m_FieldValue;
        ...
        public override void Decoder(JsonData jsonData)
        {
            ...
            m_FieldValue = (string)jsonData["FieldValue"];
