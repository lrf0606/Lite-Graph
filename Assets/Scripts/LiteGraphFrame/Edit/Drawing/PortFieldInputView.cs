...
namespace LiteGraphFrame
{
    class PortFieldInputView : VisualElement
    {
        ...
        public void CreateFieldInput(FieldPortData portData)
        {
            ...
            else if (fieldType == typeof(string).FullName)
            {
            ...
            else if (fieldType == typeof(float).FullName)
            {
            ...
            else if (fieldType == typeof(Vector2).FullName)
            {
            ...
            else if (fieldType == typeof(Vector3).FullName)
            {
